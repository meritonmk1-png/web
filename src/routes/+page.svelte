<script>
    ...
    const seoData = {
        title: "meriton.selimi.tech/ - AI-Powered Digital Studio",
        description:
            "We don't build websites. We craft digital experiences that defy expectations. Launch in 7 days with AI-enhanced design.",
        canonical: "https://meriton.selimi.tech",
    };
</script>
